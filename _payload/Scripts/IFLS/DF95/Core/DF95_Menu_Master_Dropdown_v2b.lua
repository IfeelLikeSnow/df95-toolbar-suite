...
-- DF95: write chain META target to track extstate if LAST_CHAIN_META is set
do
  local res = reaper.GetResourcePath()
  local sep = package.config:sub(1,1)
  local helper = res..sep.."Scripts"..sep.."IFLS"..sep.."DF95"..sep.."Tools"..sep.."DF95_ChainMeta_WriteTarget.lua"
  if reaper.file_exists(helper) then dofile(helper) end
end
