-- @description Bias Snapshot – Glitch
-- @version 1.0
-- @about Applies Glitch.json into DF95_ArtistBias.json
local r = reaper
local sep = package.config:sub(1,1)
local res = r.GetResourcePath()
local base = res..sep.."Data"..sep.."DF95"
local fn = base..sep.."BiasProfiles"..sep.."Glitch.json"
...
g:write(d); g:close()
r.ShowMessageBox("Bias-Profil geladen: Glitch","DF95",0)
