-- @description Bias Snapshot – Neutral
-- @version 1.0
-- @about Applies Neutral.json into DF95_ArtistBias.json
local r = reaper
local sep = package.config:sub(1,1)
local res = r.GetResourcePath()
local base = res..sep.."Data"..sep.."DF95"
local fn = base..sep.."BiasProfiles"..sep.."Neutral.json"
...
g:write(d); g:close()
r.ShowMessageBox("Bias-Profil geladen: Neutral","DF95",0)
