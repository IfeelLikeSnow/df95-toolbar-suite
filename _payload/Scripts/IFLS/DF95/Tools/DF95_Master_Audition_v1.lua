-- @description Master Audition (cycle & report)
-- @version 1.0
local r = reaper
...
local index_json = res..sep.."Data"..sep.."DF95"..sep.."DF95_Master_Index.json"
local list = common.list_from_index(index_json, "Master")
local report_dir = res..sep.."Data"..sep.."DF95"..sep.."Reports"
reaper.RecursiveCreateDirectory(report_dir,0)
local rep = {}
rep[#rep+1] = "[DF95] Master Audition Report"
if #list==0 then r.ShowMessageBox("Keine Master-Chains gefunden.","DF95",0) return end
...
local out = report_dir..sep.."Master_Audition_"..os.date("!%Y%m%d_%H%M%S")..".txt"
