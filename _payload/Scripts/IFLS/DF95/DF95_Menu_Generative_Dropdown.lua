-- DF95_Menu_Generative_Dropdown.lua (V3 Hub Entrypoint)
...
Hubs.run_hub("experimental_generative")


--[[
LEGACY CONTENT (preserved for reference):
-- @description Generative Dropdown (CSV-driven)
-- @version 1.2
-- @author IfeelLikeSnow
-- @about Dropdown nur für Kategorie: Generative. Liest Data/DF95 Katalog, lädt .rfxchain.
local r = reaper
...
if __df95_cfg.features and __df95_cfg.features.enable_experimental == false then
  local MB = dofile(__df95_base .. "/Scripts/DF95Framework/Lib/DF95_MenuBuilder.lua")
  MB.show_disabled_menu({
    title = "DF95 Menü",
    reason = "Experimental deaktiviert",
