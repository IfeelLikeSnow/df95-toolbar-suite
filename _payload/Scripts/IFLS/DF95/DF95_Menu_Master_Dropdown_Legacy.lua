-- @description Master Dropdown (CSV-driven)
-- @version 1.2
-- @author IfeelLikeSnow
-- @about Dropdown nur für Kategorie: Master. Liest Data/DF95 Katalog, lädt .rfxchain.
local r = reaper
...
if choice and map[choice] then
  local it = map[choice]
  local m = reaper.GetMasterTrack(0); Loader.load_chain_on_track(it.rel, m)
end
