-- DF95_Menu_Artist_Dropdown.lua (V3 Hub Entrypoint)
...
Hubs.run_hub("artist_menu")

--[[ 
LEGACY implementation preserved at:
  DF95_Menu_Artist_Dropdown_Legacy.lua
]]


--[[
LEGACY CONTENT (preserved for reference):
-- @description Artist Dropdown (CSV-driven)
-- @version 1.2
-- @author IfeelLikeSnow
-- @about Dropdown nur für Kategorie: Artist. Liest Data/DF95 Katalog, lädt .rfxchain.
local r = reaper
