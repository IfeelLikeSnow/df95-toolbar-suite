-- @description FXBus Audition (cycle & report)
-- @version 1.0
local r = reaper
...
local index_json = res..sep.."Data"..sep.."DF95"..sep.."DF95_FXBus_Index.json"
local list = common.list_from_index(index_json, "FXBus")
local report_dir = res..sep.."Data"..sep.."DF95"..sep.."Reports"
reaper.RecursiveCreateDirectory(report_dir,0)
local rep = {}
rep[#rep+1] = "[DF95] FXBus Audition Report"
if #list==0 then r.ShowMessageBox("Keine FXBus-Chains gefunden.","DF95",0) return end
...
local out = report_dir..sep.."FXBus_Audition_"..os.date("!%Y%m%d_%H%M%S")..".txt"
